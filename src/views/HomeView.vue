...
const toWorkflow = () => {
  console.log('toWorkflow')
  let row = {
    create_time: '2024-10-10T14:28:45.546',
    update_time: '2025-02-28T16:29:29.168',
    id: 'e6cf6fdc-86d0-11ef-a942-0242ac190002',
    name: 'test01',
    desc: '',
    prologue: '您好，我是开发小助手，您可以向我提出MaxKB使用问题。\n- MaxKB如何安装？\n- 如何收费？\n- 收费版功能差异',
    dialogue_number: 0,
    dataset_setting: {
  ...
  router.push({
    path: `/application/${row.id}/workflow`,
  })
}
</script>
...
<template>
  <div>
    ...
    <!-- <g-vue></g-vue> -->
    <el-button @click="toWorkflow">去workflow</el-button>
  </div>
</template>
