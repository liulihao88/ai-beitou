...
class AppNode extends HtmlResize.view {
  ...
  constructor(props: any, VueNode: any) {
    ...
    console.log(`58 nodeDict[props.model.type].properties`, nodeDict[props.model.type].properties);
    console.log(`59 nodeDict[props.model.type].properties.config`, nodeDict[props.model.type].properties.config);
